...
foldDib fFig fRot fEsp fRot45 fApi fJun fEnc d = case d of
    ...
    Rotar d a -> fRot (foldDib fFig fRot fEsp fRot45 fApi fJun fEnc d) -- si d es una rotacion, aplico foldDib a d para obtener el dibujo y aplico fRot a ese dibujo
    Espejar d a -> fEsp (foldDib fFig fRot fEsp fRot45 fApi fJun fEnc d) -- lo mismo que rotar
    Rot45 d a -> fRot45 (foldDib fFig fRot fEsp fRot45 fApi fJun fEnc d) -- lo mismo que rotar
    Apilar x y d1 d2 a -> fApi x y (foldDib fFig fRot fEsp fRot45 fApi fJun fEnc d1) (foldDib fFig fRot fEsp fRot45 fApi fJun fEnc d2) -- si d es una apilacion, aplico foldDib a d1 y d2 para obtener los dibujos y aplico fApi a esos dibujos 
    Juntar x y d1 d2 a -> fJun x y (foldDib fFig fRot fEsp fRot45 fApi fJun fEnc d1) (foldDib fFig fRot fEsp fRot45 fApi fJun fEnc d2) -- lo mismo que apilar
    Encimar d1 d2 a -> fEnc (foldDib fFig fRot fEsp fRot45 fApi fJun fEnc d1) (foldDib fFig fRot fEsp fRot45 fApi fJun fEnc d2) -- si d es una encimacion, aplico foldDib a d1 y d2 para obtener los dibujos y aplico fEnc a esos dibujos

-- Demostrar que `mapDib figura = id`
mapDib :: (a -> Dibujo b) -> Dibujo a -> Dibujo b
mapDib f (Figura a) = f a
mapDib f (Rotar d a) = Rotar (mapDib f d) a
mapDib f (Espejar d a) = Espejar (mapDib f d) a
mapDib f (Rot45 d a) = Rot45 (mapDib f d) a
